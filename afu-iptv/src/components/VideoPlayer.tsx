...
export function VideoPlayer({ streamUrl, channelName, isOpen, onClose }: VideoPlayerProps) {
    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/95 backdrop-blur-md">
      <div className="w-full px-4">
        <div className="relative mx-auto w-full max-w-5xl aspect-video">
          {/* Video Container */}
          <div
            className="absolute inset-0 bg-black rounded-2xl overflow-hidden shadow-2xl"
